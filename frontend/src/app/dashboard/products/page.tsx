                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            {formData.type === 'GOODS' && (
                                <div className="col-span-2">
                                    ...
                                    <input
                                        type="number"
                                        className={`w-full rounded-lg bg-[var(--background)] border border-gray-300 dark:border-[var(--card-border)] p-3 text-[var(--foreground)] focus:border-[var(--primary)] focus:ring-1 focus:ring-[var(--primary)] focus:outline-none transition-all shadow-sm ${user?.role === 'KASIR' ? 'opacity-50 cursor-not-allowed bg-gray-100 dark:bg-gray-800' : ''}`}
                                    ...
                                    />
                                    {user?.role === 'KASIR' ? (
                                        <p className="text-xs text-red-400 mt-1">Cashiers cannot edit stock directly. Use 'Quick Restock' action instead.</p>
                                    ) : (
